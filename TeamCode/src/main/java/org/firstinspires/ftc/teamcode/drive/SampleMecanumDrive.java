...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
      ...
      //  I2cDeviceSynchSimple device = hardwareMap.i2cSimple.get("pinpoint");
     //   GoBildaPinpointDriver pinpointDriver = new GoBildaPinpointDriver(device, true);

        // TODO: if desired, use setLocalizer() to change the localization method
        // setLocalizer(new StandardTrackingWheelLocalizer(hardwareMap, lastTrackingEncPositions));
      //  drive.setLocalizer(new My)
